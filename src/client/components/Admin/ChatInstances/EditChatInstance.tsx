...
import { useEditChatInstanceMutation } from '../../../hooks/useChatInstanceMutation'
...
const EditChatInstance = forwardRef(
  ({ chatInstance, setFormOpen }: Props, ref) => {
    ...
    const handleCreate = () => {
      try {
        ...
        setFormOpen(false)
        enqueueSnackbar('Course chat instance updated', { variant: 'success' })
      } catch (error: any) {
...
export default EditChatInstance
