  ...
  if (courseEnded) {
    return (
      <Tooltip title={t('chat:courseChatEndedInfo')}>
        <Chip label={t('chat:courseChatEnded')} color="error" icon={<InfoOutlinedIcon fontSize="small" />} />
      </Tooltip>
    )
  } else if (!courseEnabled) {
    return (
      <Tooltip title={t('chat:courseChatNotActivatedInfo')}>
        <Chip label={t('chat:courseChatNotActivated')} color="warning" icon={<InfoOutlinedIcon fontSize="small" />} />
      </Tooltip>
    )
  }
      ...
      <Box p={3}>
        ...
        {course ? (
          <>
            ...
            <TextButton
              data-testid="course-exit-button"
              onClick={() => {
                navigate('/general')
          ...
          <TextButton data-testid="select-course-button" startIcon={<ChevronRightIcon />} onClick={() => navigate(`/general/courses`)}>
