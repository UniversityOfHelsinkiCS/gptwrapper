...
import { Box, Typography, FormControlLabel, Switch, Divider, Stack } from '@mui/material'
...
const EditCourseForm = forwardRef<HTMLElement, EditCourseFormProps>(({ course, setOpen, user }, ref) => {
  ...
  return (
    ...
    >
      ...
      <Stack direction="row" justifyContent="space-between">
        {course.usageLimit > 0 && <RedButton onClick={handleDeactivate}>{t('course:deActivate')}</RedButton>}
