...
import { AccessLevel, ChatStatus, Locales, Statistic, Term } from '@shared/types'
...
export type PromptEditorFormState = Pick<Prompt, 'name' | 'systemMessage' | 'hidden' | 'ragHidden' | 'userId'> & {
  userInstructions: string
